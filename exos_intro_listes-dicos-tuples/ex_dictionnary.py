...
def lists_to_dict(list_1, list_2):
    dict_lists = {}
    # Placer les clés dans le dictionnaire:
    for value in list_1:
        dict_lists[value] = 0

    #placer les valeurs de liste_2 dans le dictionnaire:
    for value, key in zip(list_2, dict_lists.keys()):
...
liste1 = [1, 2, 3]
liste2 = ['a', 'b', 'c']
print(lists_to_dict(liste1, liste2))
...
dict_test = {5: 0, 4: 0, 'a': 0, 'x': 0, 78: 0, 'b': 0, 78: 0, 1: 0}
print(dict_to_keys_lists(dict_test))